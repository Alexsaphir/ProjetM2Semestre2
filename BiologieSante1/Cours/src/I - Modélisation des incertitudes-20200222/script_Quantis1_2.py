...
draw_cdf_loiUnifDisc.setLegendName('loi S1/S2')
...
draw_pdf_loiUnifDisc.setLegendName('loi S1/S2')
...
# loi discrete
# S1
pairColl = UserDefinedPairCollection(0)
N = 5
support = NumericalPoint(N)
for i in range(N):
  support[i] = 1 + float(i) / N
print support
K = 16
weight = 1.0
for k in range(K):
