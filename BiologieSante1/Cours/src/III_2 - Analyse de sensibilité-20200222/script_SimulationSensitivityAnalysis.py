...
importanceFactorsRangeGraphProbability = algo.drawImportanceFactorsRange(True, 1e-6, 1e-2)
importanceFactorsRangeGraphProbability.setLogScale(1)
importanceFactorsRangeGraphProbability.draw("importanceFactorsRangeGraphProbabilitySample" + comparisonOperator.getClassName(), 1024, 480)
...
importanceFactorsRangeGraphThreshold.draw("importanceFactorsRangeGraphThresholdSample" + comparisonOperator.getClassName(), 1024, 480)
